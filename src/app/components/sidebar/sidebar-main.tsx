                            ...
                            <CardContent>
                                ...
                                <div className="flex flex-col space-y-2.5">
                                    ...
                                    <Select onValueChange={
                                            (value) => onAlgorithmChange(value as Algorithm)
                                        }
                                        value={algorithm}>
                                ...
                                <div className="flex flex-col space-y-2.5">
                                    ...
                                    <Select onValueChange={
                                            (value) => updateMaze(value as Maze)
                                        }
                                        value={maze}>
                        ...
                        <TabsContent value="node"  className={
                            ...
                            <div className="grid w-full items-center gap-4 space-y-2.5">                               
                                ...
                                <div className="flex flex-col space-y-2.5">
                                    ...
                                    <Slider value={[n_speed]}
                                        min={0.6}
                                        max={1.5}
                                        step={0.1}
                                        onValueChange={(value) => setNodeSpeed(value[0])}
                                    />
                                </div>
                            </div>
                        </TabsContent>
